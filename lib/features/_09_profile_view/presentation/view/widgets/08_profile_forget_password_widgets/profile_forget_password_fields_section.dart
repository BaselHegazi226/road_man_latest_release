...
class ProfileForgetPasswordFieldsSection extends StatefulWidget {
  const ProfileForgetPasswordFieldsSection({
    super.key,
    required this.emailEditingController,
  });
  final TextEditingController emailEditingController;
  @override
  State<ProfileForgetPasswordFieldsSection> createState() =>
      _ProfileForgetPasswordFieldsSectionState();
}

class _ProfileForgetPasswordFieldsSectionState
    extends State<ProfileForgetPasswordFieldsSection> {
  String? email;
