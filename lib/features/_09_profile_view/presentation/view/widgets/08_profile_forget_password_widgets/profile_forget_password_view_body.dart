...
import 'package:road_man_project/features/_09_profile_view/presentation/view/widgets/08_profile_forget_password_widgets/profile_forget_password_input_data_section.dart';

class ProfileForgetPasswordViewBody extends StatelessWidget {
  const ProfileForgetPasswordViewBody({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const ProfileForgetPasswordInputDataSection(),
        ],
      ),
    );
  }
